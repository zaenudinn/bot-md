...
let wel = API('popcat', '/welcomecard', {
                                background: 'https://telegra.ph/file/3f464b5907532a1650091.jpg',
                                text1: welc,
 ...
 //bang wel lo ko  nyamain sama yang sebelah sih bacot kontol walaupun nyamain tetap aja gw harus record su susah gk ngampang kata orang orang gampang bagi gw susah ngab gw masih pemula yang ngerti ² aja lah  
// record karena beda scrip sama code nya kalau tau soal sc ngerti lah 🗿 
                                                                                                  
/* let welcom = 'https://telegra.ph/file/aab124271570c51f76aac.jpg'

 let godbye = 'https://telegra.ph/file/deaf59bc3e5216eaae814.jpg' 
  conn.sendButtonImg(id, await(await fetch(action === 'add' ? wel : lea)).buffer(), 'Group Messege', text, action == 'add' ? 'ᴡᴇʟᴄᴏᴍᴇ' : 'sᴀʏᴏɴᴀʀᴀᴀ', action === 'add' ? '.intro' : 'hehe🗿',
     )   */                                         
