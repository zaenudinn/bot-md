...
let arrayMenu = ['all', 'anime', 'update', 'berita', 'edukasi', 'news', 'random', 'logo', 'menbalas', 'game', 'xp', 'islamic', 'stiker', 'rpg', 'kerangajaib', 'quotes', 'asupan', 'admin', 'group', 'premium', 'internet', 'anonymous', 'nulis', 'downloader', 'tools', 'fun', 'database','quran', 'vote', 'catatan', 'absen', 'virus', 'nsfw', 'audio', 'jadibot', 'random', 'info', 'audioanime', 'owner', 'nocategory']
...
const sections = [
   {
    ...
    rows: [
        ...
        {title: `📑 ${pmenus} Quotes`, rowId: ".? quotes", description: "Random Inspirasi"},        
         {title: `🙎‍♀️ ${pmenus} Asupan`, rowId: ".? asupan", description: "Menampilkan Asupan DiBot"},        
...
const listMessage = {
  text: tek,
  footer: `Silahkan Kak ${usrs.registered ? usrs.name : conn.getName(m.sender)} Klik Button dibawah untuk melihat Semua List Menu bot\n${wm2}`,
...
ptt: false, seconds: 0,contextInfo: {
 ...
 mediaUrl: 'tautanwa',
    ...
    // MAU YANG NO ENC fix-bot-v3 30K AJA , MINAT PC GW wa.me/6282124690625
